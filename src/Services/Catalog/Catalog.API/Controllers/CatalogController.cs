    ...
    public class CatalogController : ControllerBase {
        ...
        public IActionResult GetCatalog () {
            var catalog = new CatalogItem[] {
                new CatalogItem { Id = new Guid ("11111111-0000-0000-0000-000000000000"), Name = "AMD Ryzen 3 2200G v2", UnitPrice = 11.11m },
                new CatalogItem { Id = new Guid ("22222222-0000-0000-0000-000000000000"), Name = "Intel i3 8400 v2", UnitPrice = 22.22m },
