...
using ZhangJian.YunFeiShop.BuildingBlocks.Integration;
...
namespace ZhangJian.YunFeiShop.Services.Ordering.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIntegrationEventService<OrderingContext>(options => 
            {
                options.ClientName = "yunfeishop_Ordering";
                options.EventLogContextOptionsAction = (eventLogContextOptions, connection) => eventLogContextOptions.UseSqlite(connection);
            });
