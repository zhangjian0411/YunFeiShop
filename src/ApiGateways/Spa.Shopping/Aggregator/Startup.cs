...
namespace ZhangJian.YunFeiShop.BFF.Spa.Shopping.HttpAggregator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<UrlsConfig>(Configuration.GetSection("service_hosts"));

            services.AddHttpClient<ICatalogService, CatalogHttpService>();
            services.AddHttpClient<ICartService, CartHttpService>();
